...
public class StaticMethods {
	...
	/**
	 * The triple {x,f,g} where
	 * <dl>
	 * <dt>x</dt>
	 * <dd>is the coordinate vector of a point, initially <code>null</code></dd>
	 * <dt>f</dt>
	 * <dd>is the function value at that point, initially <code>NAN</code>,</dd>
	 * <dt>g</dt>
	 * <dd>is the gradient at that point, initially <code>null</code>.</dd>
	 * </dl>
	 */
	public static class XFG {
		/**
		 * The function value, initially <code>NAN</code>
		 */
		public double f = Double.NaN;

		/**
		 * The gradient, initially <code>null</code>
		 */
		public double[] g = null;

		/**
		 * The coordinate vector, initially <code>null</code>
		 */
		public double[] x = null;

		/**
		 * @param o The object to be cloned
		 * @return The clone of the given object. Changes to the original object do not
		 *         affect the clone and vice versa.
		 */
		XFG clone(XFG o) {
			XFG result = new XFG();
			result.f = o.f;
			result.g = o.g == null ? null : o.g.clone();
			result.x = o.x == null ? null : o.x.clone();
			return result;
		}

//        public SearchHistoryElement clone() {
//            SearchHistoryElement result = new SearchHistoryElement(this);
//            return result;
//        }
		...
		public String toString() {
			...
			out.format("x = %s", StaticMethods.simpleVectorPrint(this.x));
			out.format(", g = %s", StaticMethods.simpleVectorPrint(this.g));
			out.format(", f = %s", StaticMethods.simpleScalarPrint(f));
			return sw.toString();
		}
	}
	...
	/**
	 * @param msgs the text to be printed
	 * @return lines to be printed.
	 */
	public static String boxPrint(final java.util.List<String> msgs) {
		if (msgs == null) {
			return null;
		}
	 ...
	 */
	public static String boxTitle(final String title, final String boxPrint) {
		final int titleOffset = 2;
		final String[] split = boxPrint.split("\\R", 2);// Split off the top line.
		...
		while (!done) {
			// Done if included entire top line and entire title text.
		...
		sb.append(split[1]);// Append the rest of the box and contents.
		return sb.toString();
	}
	...
	public static String compactTimeStamp() {
		return compactTimeStamp(System.currentTimeMillis());
	}
	...
	/**
	 * @param mean       The mean vector of the density
	 * @param covariance The covariance matrix of the density
	 * @return An ellipse showing the covariance.
	 * @throws org.apache.commons.math3.exception.MathArithmeticException if an
	 *                                                                    arithmetic
	 *                                                                    exception
	 *                                                                    occurs
	 */
	public static Shape ellipseFromCovariance(final double[] mean,
			final org.apache.commons.math3.linear.RealMatrix covariance)
			throws org.apache.commons.math3.exception.MathArithmeticException {
		final org.apache.commons.math3.linear.EigenDecomposition eigenDecomposition = new org.apache.commons.math3.linear.EigenDecomposition(
				covariance);
	 ...
	 * @return a <code>String</code> describing the exception.
	 */
	...
	/**
	 * Returns the Hessian matrix of a quadratic function which matches given
	 * gradients at given points.
	 *
	 ...
	 * @throws DimensionMismatchException if the dimension is not exactly one less
	 *                                    than the number of points
	 * @throws NoDataException            if there are no points
	 * @throws NullArgumentException      if the argument is null
	 * @throws SingularMatrixException    if the matrix is singular
	 * @throws NonSquareMatrixException   if the matrix is not square
	 * @throws OutOfRangeException        if a quantity is out of range.
	 */
	...
	/**
	 * @param logPath The path representing the curve to be plotted
	 * @return a printable listing of the path
	 */
	...
	/**
	 * Returns the value of the logistic function for the given argument value:
	 *
	 * <math xmlns="http://www.w3.org/1998/Math/MathML"> <semantics> <mrow> <mfrac>
	 * <mn>1</mn> <mrow> <mrow> <mn>1</mn> <mo stretchy="false">+</mo> <msup>
	 * <mi>e</mi> <mrow> <mrow> <mo stretchy="false">−</mo> <mi>x</mi> </mrow>
	 * </mrow> </msup> </mrow> </mrow> </mfrac> </mrow> </semantics> </math>
	 *
	 * @param x The argument value
	 * @return the value of the logistic function at the given argument.
	 */
	...
	/**
	 * Given the coordinates of a set of points and the gradients at those points,
	 * returns the coordinates of the location of the minimum magnitude of the
	 * gradient.
	 *
	 ...
	 * @throws NoDataException            if there is no data
	 * @throws NullArgumentException      if the argument is null
	 * @throws MathArithmeticException    if there is an arithmetic exception
	 * @throws SingularMatrixException    if the matrix is singular
	 * @throws NonSquareMatrixException   if the matrix is not square
	 * @throws OutOfRangeException        if a quantity is out of range
	 */
	...
	public static double nonQuadraticity(XFG xfg1, XFG xfg2) {
		return nonQuadraticity(xfg1.x, xfg1.f, xfg1.g, xfg2.x, xfg2.f, xfg2.g);
	}
	...
	/**
	 * @param is the intput stream
	 * @return the byte array read from the input stream
	 * @throws IOException      if an IO exception occurs
	 * @throws RuntimeException if not able to read four bytes.
	 */
	 ...
	 * @return lines to be printed.
	 */
	public static String ulinePrint(final List<String> text) {
		if (text == null) {
			return null;
		}
		final String leftOrRight = " ";
		...
		final String bottomLeft = " ";
		final String bottomRight = " ";
		return StaticMethods.boxPrint(text, leftOrRight, topOrBottom, upperLeft, upperRight, bottomLeft, bottomRight);
	}
	 ...
	 * minuend.
	 *
	 * @param minuend    The vector from which the subtrahend is to be subtracted
